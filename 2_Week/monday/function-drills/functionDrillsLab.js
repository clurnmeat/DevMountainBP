...
//CODE HERE
const printName = (name1) => console.log(`${name1}`);
printName(`Cameron`);
////////////////// PROBLEM 4 ////////////////////
/*
...
//CODE HERE
function compareNums(numb1, numb2) {
  if (numb1 > numb2) {
    return numb1;
  } else if (numb2 > numb1) {
    return numb2;
...
console.log(exclaimThree(`I love coding`));
////////////////// PROBLEM 9 ////////////////////
...
let colorRating = console.log(faveColorFinder(`black`));
////////////////// PROBLEM 12 ////////////////////
...
function myFunction(strn) {
  let stringUpper = strn.toUpperCase();
...
console.log(emailCheck(`johhna@dooodle.com`));
...
let arrayIsAscendig = isInOrder(sampleArray);
console.log(arrayIsAscendig);
////////////////// PROBLEM 22 ////////////////////

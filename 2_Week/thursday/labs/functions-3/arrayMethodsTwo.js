...
// CODE HERE
const newArr = numbers.map((el) => console.log(el / 2));
////////// PROBLEM 3 //////////
...
// CODE HERE
const citiesEndingInI = cities.filter((el) => el[el.length - 1] === "i");
...
fruits.forEach((el) => {
  if (el.color === `red`) {
    console.log(`The fruit with index ${fruits.indexOf(el)} is an apple`);
  } else if (el.color === `orange`) {
    console.log(`The fruit with index ${fruits.indexOf(el)} is an orange`);
  } else {
    console.log(
      `The fruit with index ${fruits.indexOf(el)} is neither apple or orange`
    );
  }
});
...
// The fruit with index 0
// The fruit with index 1 is an orange
// The fruit with index 2
// The fruit with index 3 is an apple
////////// PROBLEM 5 //////////
...
const riceFoods = foods.filter((el) => el.tags.includes("rice"));
const prices = riceFoods.reduce((a, b) => a + b.price, 0);
